...
def formatar_moeda(valor, casas=2):
...
with tabs[2]:
    ...
    st.metric("Preço Líquido PVU", formatar_moeda(preco_pvu_anidro_int) + "/m³")
    ...
    st.metric("CBIO Líquido", formatar_moeda(valor_cbio_liquido_por_m3_anidro) + "/m³")
...
with tabs[3]:
    ...
    st.metric("Preço Líquido PVU", formatar_moeda(preco_pvu_hidratado_int) + "/m³")
    # Calcula valor_cbio_liquido_por_m3 a partir do valor_cbio_liquido_por_cbio
    ...
    st.metric("CBIO Líquido", formatar_moeda(valor_cbio_liquido_por_m3_hidratado) + "/m³")
    ...
    st.metric("Preço PVU + CBIO", formatar_moeda(preco_pvu_cbio_hidratado) + "/m³")
    st.metric("Crédito Tributário", formatar_moeda(credito_trib_hidratado) + "/m³")
...
with tabs[4]:
    ...
    with col_a3:
        ...
        st.metric("SUGAR Cristal Esalq", formatar_moeda(esalq_saca) + "/saca")
    with col_a4:
        malha30_saca = preco_sugar_cristal_export_malha30_brl_saca
        preco_malha30_str = formatar_moeda(malha30_saca) + "/saca"
